{def $social_pagedata = social_pagedata('dimmi')}
                    ...
                    <tr>
                        <td align='center' valign='top'>
                          <small>
                            ...
                            {'%privacy_link_start%Informazioni sulla privacy%privacy_link_end%'|i18n('dimmi/mail/registration',, hash( '%privacy_link_start%', concat( '<a href=http://', $social_pagedata.site_url, '/dimmi/info/privacy/>' ), '%privacy_link_end%', '</a>' ))} -
                            {'%terms_link_start%Termini di utilizzo%terms_link_end%'|i18n('dimmi/mail/registration',, hash( '%terms_link_start%', concat( '<a href=http://', $social_pagedata.site_url, '/dimmi/info/terms/>' ), '%terms_link_end%', '</a>' ))}
                          </small>
                        </td>
                    </tr>
                </table>
