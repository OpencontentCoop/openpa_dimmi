{def $replies = fetch('content','list', hash( 'parent_node_id', $node.node_id, 'limit', $reply_limit|sum($view_parameters.offset), 'sort_by', array( published, false() ) ) )}
{set $replies = $replies|reverse()}
    ...
    <div class="col-md-10 col-md-offset-1">
        <div id="post_comments">
            {include name=navigator
                    uri='design:dimmi/forum/replies_navigator.tpl'
