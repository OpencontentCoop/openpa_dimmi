<div class="row service_teaser">
  ...
  <div class="service_photo col-sm-4 col-md-4 hidden-xs hidden-sm">
    ...
    <section class="call_to_action">
      <a href={concat( 'dimmi/forums/', $node.node_id )|ezurl()} class="btn btn-primary btn-lg btn-block">{"Partecipa"|i18n( 'dimmi/forum' )}</a>
    </section>
  ...
  <div class="service_details {if $node|has_attribute('image')}col-sm-8 col-md-8{else}col-sm-12 col-md-12{/if}">      
      <h2 class="section_header skincolored noborder">
        ...
        <a href={concat( 'dimmi/forums/', $node.node_id )|ezurl()} class="btn btn-primary btn-lg pull-right"><strong>{"Clicca qui per partecipare"|i18n( 'dimmi/forum' )}</strong></a>
